...
export default function InvitationAcceptancePage() {
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      try {
        ...
        // Find and set the newly joined organization as current
        // Use the organizationId from the accept result or from the invitation
  ...
  // Loading state - only wait for invitation fetch, not auth
  if (state === 'loading') {
    return (
